import 'package:kite_bird/cooprates/models/cooprates_models.dart' show CooprateCardModel, where;
import 'package:kite_bird/cooprates/requests/cooprates_requests_manager.dart';
import 'package:kite_bird/cooprates/serializers/cooprates_serializers.dart' show CooprateCardCreateSerilizer;
...
class CooprateCardController extends ResourceController{
  CooprateCardModel cooprateCardModel = CooprateCardModel();
  ...
  Future<Response> create(
    @Bind.body(require: ['consumerKey', 'consumerSecret']) 
    CooprateCardCreateSerilizer cooprateCardCreateSerilizer) async{
    ...
    final CooperateRequest _cooperateRequest = CooperateRequest(
      ...
      metadata: cooprateCardCreateSerilizer.asMap()
    );
    ...
    _requestId = _cooperateRequest.requestId();
      ...
      final CooprateCardModel _cooprateCardModel = CooprateCardModel(
        ...
        consumerKey: cooprateCardCreateSerilizer.consumerKey,
        consumerSecret: cooprateCardCreateSerilizer.consumerSecret,
      );

      final Map<String, dynamic> _res = await _cooprateCardModel.save();
  ...
  Future<Response> update(
    ...
    _requestId = _cooperateRequest.requestId();
      ...
      final Map<String, dynamic> _res = await _cooprateCardModel.findAndModify(
        selector: where.eq('cooprateCode', cooprateCode),
        obj: _cooprateCardModel.asMap()
      );
