...
class CooprateMpesaBcTransactionController extends ResourceController{
  ...
  Future<Response> create(
    ...
    final MpesaRequest _mpesaRequest = MpesaRequest(
      ...
      mpesaRequestsType: MpesaRequestsType.bc,
      metadata: cooprateMpesaCbTransactionSerializer.asMap()
    );
    ...
    _requestId = _mpesaRequest.requestId();
      ...
      final Map<String, dynamic> _mpesaRes = await _mpesaOperations.bc(
